...
export function EmptyStateSinAperturas({ onReset }: SinDatosProps) {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center px-4">
      ...
      <p className="text-base text-gray-500 dark:text-gray-400 mb-5 max-w-xs">
        No hay aperturas registradas para este consejo y tipo de elección.
      </p>
...
export function EmptyStateBusquedaApertura({ termino, onLimpiar }: BusquedaVaciaProps) {
  return (
...
export function EmptyStateErrorAperturas({ onReintentar }: ErrorCargaProps) {
  return (
    <div
