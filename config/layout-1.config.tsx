...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  { heading: 'Sesiones de Consejo', permission: 'sesionesdelconsejo' },
  {
      title: 'Sesiones',
      icon: Presentation,
      path: '/sesiones',
      badge: 'New',
      permission: 'sesionesdelconsejo.sesiones',
  },
  { heading: 'Bodegas Electorales', permission: 'bodegas' },
  { 
      ...
      badge: 'New',
      disabled: false,
      permission: 'bodegas.bodegas.bitacoraaperturas',
  },
  { heading: 'Mecanismos de Recolección', permission: 'mecanismosderecoleccion'},
  { 
      ...
      badge: 'New',
      disabled: false,
      permission: 'mecanismosderecoleccion.estudiosfactibilidad',
  },
  { 
      ...
      badge: 'New',
      disabled: false,
      permission: 'mecanismosderecoleccion.mecanismosderecoleccion',
  },
  { heading: 'Documentación y Material', permission: 'documentacionymaterial' },
  { 
      ...
      badge: 'New',
      disabled: false,
      permission: 'documentacionymaterial',
  },
  { heading: 'Computos Electorales', permission: 'computoselectorales' },
  { 
      title: 'Monitoreo de Captura', 
      icon: Presentation,
      path: '/coming-soon', 
      badge: 'New',
      disabled: false,
      permission: 'computoselectorales.computoselectorales.monitoreo',
  },
  { 
      title: 'Resultados', 
      icon: Presentation,
      ...
      badge: 'New',
      disabled: false,
      permission: 'computoselectorales.computoselectorales.resultados',
  },
  { 
      title: 'Acta Voto en el Extranjero', 
      icon: Presentation,
      path: '/coming-soon', 
      badge: 'New',
      disabled: false,
      permission: 'computoselectorales.computoselectorales.capturavotoenelextranjero',
  },
  { 
      title: 'Acta de Computo de Gubernatura', 
      icon: Presentation,
      path: '/coming-soon', 
      badge: 'New',
      disabled: false,
      permission: 'computoselectorales.computoselectorales.resultadosdistitalesgob',
  },
  { heading: 'Recepción de Paquetes', permission: 'recepciondepaquetes' },
  { 
      title: 'Monitoreo de Captura', 
      icon: Presentation,
      path: '/coming-soon', 
      badge: 'New',
      disabled: false,
      permission: 'recepciondepaquetes.monitoreo',
  },
  { 
      title: 'Resultados Prelimiminares', 
      icon: Presentation,
      path: '/coming-soon', 
      badge: 'New',
      disabled: false,
      permission: 'recepciondepaquetes.prep',
  },
  { heading: 'Catálogos', permission: 'catalogos' },
  {
    title: 'Roles y Permisos',
    icon: KeySquare,
    path: '/roles',
    permission: 'catalogos.rolesypermisos',
  },
  {
    title: 'Usuarios',
    icon: ShieldUser,
    path: '/usuarios',
    permission: 'catalogos.usuarios',
  },
