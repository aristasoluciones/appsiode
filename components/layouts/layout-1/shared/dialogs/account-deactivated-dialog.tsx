    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full max-w-[500px] max-h-[95%] scrollable-y-auto">
        <DialogHeader className="justify-end border-0 pt-5">
          <DialogTitle className="sr-only">Cuenta desactivada</DialogTitle>
          <DialogDescription className="sr-only">Información sobre la desactivación de cuenta</DialogDescription>
        </DialogHeader>
